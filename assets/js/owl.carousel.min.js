  ...
  (e.Defaults = {
      ...
      3 !== b.which &&
        (a.support.transform
          ...
          : ((d = this.$stage.position()),
            (d = { x: this.settings.rtl ? d.left + this.$stage.width() - this.width() + this.settings.margin : d.left, y: d.top })),
    ...
    (e.prototype.closest = function (b, c) {
      ...
      return (
        ...
        this.settings.loop ||
          (this.op(b, ">", h[this.minimum()]) ? (e = b = this.minimum()) : this.op(b, "<", h[this.maximum()]) && (e = b = this.maximum())),
        e
      );
    }),
  ...
  (function (a, b, c, d) {
    ...
    (e.Defaults = {
      ...
      (e.prototype.initialize = function () {
        ...
        (this._controls.$relative = (c.navContainer ? a(c.navContainer) : a("<div>").addClass(c.navContainerClass).appendTo(this.$element)).addClass(
          "disabled"
        )),
          ...
          (this._controls.$absolute = (c.dotsContainer ? a(c.dotsContainer) : a("<div>").addClass(c.dotsClass).appendTo(this.$element)).addClass(
            "disabled"
          )),
  ...
  (function (a, b, c, d) {
    ...
    var g = a("<support>").get(0).style,
      ...
      i = {
        ...
        animation: {
          end: { WebkitAnimation: "webkitAnimationEnd", MozAnimation: "animationend", OAnimation: "oAnimationEnd", animation: "animationend" },
        },
      },
      j = {
